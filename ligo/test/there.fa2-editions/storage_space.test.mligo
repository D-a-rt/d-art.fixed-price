...
let get_fa2_editions_space_contract_fixed_price (fixed_price_contract : address) : ( ((editions_entrypoints, editions_storage) typed_address) * address * address * address ) = 
    ...
    let addr, _, _ = Test.originate_from_file "/Users/thedude/Documents/Pro/D.art/there.contracts/ligo/there.fa2-editions/compile_fa2_editions_space.mligo" "editions_main" ([] : string list) michelson_str 0tez in
