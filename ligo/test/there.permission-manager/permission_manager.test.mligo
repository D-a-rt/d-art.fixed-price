...
let test_accept_admin_invitation_accept_success = 
    ...
    match result with
            Success _gas -> (
                ...
                if new_str.admin_str.admin = new_admin && new_str.admin_str.pending_admin = (None : address option)
                then "Passed"
...
let test_accept_admin_invitation_refuse_success = 
    ...
    match result with
            Success _gas -> (
                let new_str = Test.get_storage contract_add in
                if new_str.admin_str.pending_admin = (None : address option) && new_str.admin_str.admin = admin
                then "Passed"
