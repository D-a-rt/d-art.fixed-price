...
let test_balance_of_empty_no_amount = 
    let contract_add, _, _, _ = FA2_STR.get_initial_storage(false, false) in
    ...
    let result = Test.transfer_to_contract contract  (FA2 (Balance_of balance_of_requests)) 1tez in
...
let test_balance_of_empty_no_amount = 
    ...
    let result = Test.transfer_to_contract contract  (FA2 (Balance_of balance_of_requests)) 0tez in
...
let test_balance_of_empty = 
    ...
    let _gas = Test.transfer_to_contract_exn contract  (FA2 (Balance_of balance_of_requests)) 0tez in
